    ...
    */
    describe('RSS Feeds', function() {
        ...
        it('has a URL defined and not empty', function() {
            for(var i = 0; i < allFeeds.length; i++) {
                expect(allFeeds[i].url).toBeDefined(); //all feed url are defined
         ...
         */
        it('has a URL name and not empty', function() {
            for(var i = 0; i < allFeeds.length; i++) {
                expect(allFeeds[i].name).toBeDefined(); //all feed names are defined
    ...
    describe('The menu', function() {
        ...
        it('display or hide menu on click', function() {
            $('.menu-icon-link').click(); //show menu
